...
Iwaratown 是一个用于搜索和下载网络视频内容的应用程序，支持多种视频平台的搜索和下载功能。该项目采用模块化设计，便于添加新的视频平台支持。
...
1. [Bilibili](https://space.bilibili.com/616045770)
2. [QQ群](https://qm.qq.com/q/tSV005iqHI)
